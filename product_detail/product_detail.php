                    ...
                    <?php
                        if (isset($_GET['product_id'])) {
                            ...
                            while ($row=mysqli_fetch_assoc($res)) {
                                ...
                                $image=$row['image'];
                                $price=$row['price'];
                                $time=strtotime($row['product_date'])+(24*3600);                 
                            }
                                ...
                                <div class="single_product_thumb">
                                    <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                        <ol class="carousel-indicators">
                                            <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(../images/<?php echo $image; ?>);">
                                            </li>
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <a class="gallery_img" href="../images/<?php echo $image; ?>">
                                                    <img class="d-block w-100" src="../images/<?php echo $image; ?>" alt="First slide" style="width: 750px;height: 600px;">
                                                </a>
                                            </div>
