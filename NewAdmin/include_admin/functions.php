<?php 
    ...
    function update_user($user_id){
        ...
        $query="UPDATE user SET fullname='$user_name',email='$email',phNo='$phoneNo',nrc='$nrc',password='$user_password',address='$address',dob='$dob',gender='$gender',role='subscriber',cartNo='$cartNo' WHERE user_id='$user_id'";
        $result=mysqli_query($conn,$query);
        confirm_query($result);
    }
